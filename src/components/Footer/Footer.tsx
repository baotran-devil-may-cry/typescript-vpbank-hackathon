    ...
    <footer className="bg-gradient-to-r from-blue-800 to-blue-600 text-white">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-8 lg:py-12 text-center">
          ...
          <h2 className="footer-title text-2xl lg:text-3xl font-bold mb-6 lg:mb-8 tracking-wide">
            VPBANK TECHNOLOGY HACKATHON 2025
          </h2>
          
          {/* Contact section: mb-6 lg:mb-8 responsive bottom margin */}
          <div className="mb-6 lg:mb-8">
            {/* Contact label: text-lg lg:text-xl responsive text size, font-medium medium weight, mb-4 lg:mb-6 responsive bottom margin */}
